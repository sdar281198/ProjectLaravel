<x-guest-layout>
        <div class="mt-10">
            <p class="container text-center text-white text-3xl font-bold">Crear cuenta</p>
            <p class="container text-white text-center text-lg mt-4">Te enviaremos un enlace de verificación.<br>Ingresa a tu correo para completar el registro.</p>
        </div>
        <div id="registerdiv" class="mx-auto mt-5" id="register">
            ...
            <div>
                ...
                <input class="container outline-none p-2 rounded" type="text" name="usuario" value="Usuario" placeholder="Usuario">
                <i class="formulario__validacion-estado fas fa-times-circle"></i>
                <p class="formulario__input-error">El usuario tiene que ser de 4 a 16 dígitos y solo puede contener numeros, letras y guion bajo.</p>
                </div>
                <div class="mx-auto mt-4 mb-4 relative" id="grupo__nombre">
                <label for="nombre"></label>
                 <input  class="outline-none p-2 rounded" type="text" name="nombre" value="" placeholder="Nombre">
                <i class="formulario__validacion-estado fas fa-times-circle"></i>
                ...
                <label for="apellidos"></label>
                 <input  class="outline-none p-2 rounded" type="text" name="apellidos" value="" placeholder="Apellidos">
                <i class="formulario__validacion-estado fas fa-times-circle"></i>
            ...
            <div id="grupo__terminos" class="text-white">
                ...
                <div class="flex justify-center">
                    <button id="buttonregister" class="mx-auto outline-none p-3 rounded text-white" type="submit">Registrarse</button>
                </div>
                <div>
                    <p class="grid titulo text-center mt-2 text-white">o registrate con</p>
                </div>
