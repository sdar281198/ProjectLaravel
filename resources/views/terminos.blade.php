    ...
    <div id="maininter">
        ...
        <div id="terminos" class="fullContent">
            <div id="termsTitle" class="mx-auto mt-10 mb-5">
                <p class="text-center shadowspecial">TÉRMINOS Y CONDICIONES DE USO</p>
            </div>
            <div id="termsText" class="mx-auto">
                <p class="text-white">
                    ...
                    praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi.
                    Lorem ipsum dolor sit amet, cons ectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore
                    magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortiipis
                </p>
            </div>
        </div>
    </div>
